...
static ArrayList <Servicos> listamed = new ArrayList();
 ...
 public static void buscarServico(){
     ...
     public static void excluirCli(){
         ...
         public static double mediaServico(){
         ...
         public static void acimaMedia(){
             int cont=0;
             for (Servicos s1: listamed){
                 if (s1.getConsulta() > mediaServico()){
                     cont+=1;
                 }
             }
             System.out.println("\nA quantidade de serviços acima da média é: "+cont+".");
         }
                ...
                switch (op){
                    ...
                    case 5:
                        ...
                        switch (op){
                            ...
                            case 3:
                                System.out.println("\nA média de valores das consultas é: R$ "+ new DecimalFormat("0.00").format(mediaServico()));
                                break;
